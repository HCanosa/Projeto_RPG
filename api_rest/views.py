...
def login_user(request):
    ...
    senha_numerica = request.data.get('senha_numerica')

    try:
        user = User.objects.get(username=user_nickname)
        if user.password == senha_numerica:  # Aqui você pode usar hash se for o caso
